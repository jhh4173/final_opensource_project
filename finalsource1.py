...
print(culture)
list1 = ["1996", "2000", "2004", "2007", "2009", "2011", "2013", "2015", "2017", "2019"] #index로 사용할 년도를 작성한다. (통계자료)
culture.index = list1 #index를 list1로 변경한다.


print(culture) #우리나라의 문화예술관람률을 출력한다. 

print(culture["영화"]) #우리나라의 년도별 문화예술관람률 중 영화관람률을 출력한다.

print(culture["영화"].max()) #우리나라의 영화관람률 중 가장 높은 값을 출력한다.

print(culture["영화"].idxmax()) #우리나라의 영화관람률 중 가장 높은 값의 년도를 출력한다. 
